...
";
        ...
        static async Task Main(string[] args)
        {
            ...
            try
            {
                IAsyncEnumerable<string> results = RunPagedQueryAsync(client, PagedIssueQuery, "docs",
        ...
        private static async IAsyncEnumerable<string> RunPagedQueryAsync(GitHubClient client, string queryText, string repoName, CancellationToken cancel, IProgress<int> progress)
        {
            ...
            while (hasMorePages && (pagesReturned++ < 10))
            {
                ...
                yield return issues(results)["nodes"].ToString();
            }
