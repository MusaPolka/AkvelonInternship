...
Method to create and start our state machine for Main method [AsyncStateMachine(typeof(<M>d__0))]
    [DebuggerStepThrough]
    public Task M()
    {
...
And then, it calls Start() method that will call MoveNext () method stateMachine.<>t__builder.Start(ref stateMachine);
        return stateMachine.<>t__builder.Task;
    }

   
Method to create and start our state machine for Download method  [AsyncStateMachine(typeof(<Download>d__2))]
    [DebuggerStepThrough]
